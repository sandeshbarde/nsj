    ...
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3">
          ...
          <a href="/" className="border border-foreground px-6 py-3 text-[11px] tracking-[0.2em] uppercase">
            Go home
          </a>
        </div>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Argent — 925 Sterling Silver Jewellery" },
      { property: "og:description", content: "Hand-finished sterling silver jewellery, made in India." },
