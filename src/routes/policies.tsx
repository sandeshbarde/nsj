...
const SECTIONS = [
  { id: "shipping", t: "Shipping Policy", b: "Orders are dispatched within 24–48 hours. Standard delivery takes 4–6 business days and is free on orders above ₹1,500; express delivery is 1–2 business days at ₹199. Every shipment is insured and tracked." },
  { id: "returns", t: "Return Policy", b: "Unworn pieces in original packaging can be returned within 30 days of delivery. We arrange a free reverse pickup. Customised and engraved items are non-returnable." },
...
function Policies() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 md:px-8">
      ...
      <h1 className="mt-2 text-4xl md:text-5xl">Policies</h1>
